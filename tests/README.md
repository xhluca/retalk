...
- Starts two server subprocesses on localhost ports **8767-8768** (test_e2ee)
  and **8769** (test_cli). It fails fast if those ports are taken.
...
**8773**, test_receive_multi.py **8798**, test_library_api.py **8790**, test_invite_codes.py **8791**). Files run sequentially today, but unique ports keep parallel
